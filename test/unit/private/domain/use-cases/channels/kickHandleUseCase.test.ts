...
import { KickHandleUseCase } from '../../../../../../src/private/domain/use-cases/channels/kickHandleUseCase'
...
describe('KickHandleUseCase Test Suite', () => {
  ...
  describe('execute', () => {
    it('Kick handle from channel successfully', async () => {
    ...
    it('Kick handle from channel with reason successfully', async () => {
      const mockMatrixRoomsService = {
        kickHandle: jest.fn().mockResolvedValue(undefined),
      }
      ;(MatrixRoomsService as unknown as jest.Mock).mockReturnValue(
