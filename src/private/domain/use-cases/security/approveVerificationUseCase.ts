...
/**
 * Input for `ApproveVerificationUseCase`.
 *
 * @interface ApproveVerificationUseCaseInput
 */
interface ApproveVerificationUseCaseInput {
  handleId: HandleId
}
...
/**
 * Use case for approving verification.
 */
export class ApproveVerificationUseCase {
  ...
  async execute(input: ApproveVerificationUseCaseInput): Promise<void> {
    ...
    await securityService.approveVerification()
  }
}
