...
/**
 * Core entity representation of a channel invitation request business rule.
 *
 * @interface ChannelInvitationRequestEntity
 ...
 */
export interface ChannelInvitationRequestEntity {
  channelId: ChannelId
  handleId: HandleId
  reason?: string
  createdAt?: Date
